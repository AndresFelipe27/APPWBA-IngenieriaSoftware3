...
use Bufete\AplicacionBundle\Entity\Cliente;
use Bufete\AplicacionBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BufeteAplicacionBundle:Cliente')->findAll();

        return $this->render('BufeteAplicacionBundle:Cliente:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BufeteAplicacionBundle:Cliente:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BufeteAplicacionBundle:Cliente')->find($id);
        ...
        return $this->render('BufeteAplicacionBundle:Cliente:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BufeteAplicacionBundle:Cliente:edit.html.twig', array(
            'entity'      => $entity,
