...
use Bufete\AplicacionBundle\Entity\Documento;
use Bufete\AplicacionBundle\Form\DocumentoType;
...
class DocumentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BufeteAplicacionBundle:Documento')->findAll();

        return $this->render('BufeteAplicacionBundle:Documento:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BufeteAplicacionBundle:Documento:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BufeteAplicacionBundle:Documento')->find($id);
        ...
        return $this->render('BufeteAplicacionBundle:Documento:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BufeteAplicacionBundle:Documento:edit.html.twig', array(
            'entity'      => $entity,
