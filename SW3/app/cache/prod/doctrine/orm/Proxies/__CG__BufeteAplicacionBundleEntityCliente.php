 ...
 */
class Cliente extends \Bufete\AplicacionBundle\Entity\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bufete\\AplicacionBundle\\Entity\\Cliente' . "\0" . 'id', '' . "\0" . 'Bufete\\AplicacionBundle\\Entity\\Cliente' . "\0" . 'nombre', '' . "\0" . 'Bufete\\AplicacionBundle\\Entity\\Cliente' . "\0" . 'apellido', '' . "\0" . 'Bufete\\AplicacionBundle\\Entity\\Cliente' . "\0" . 'correo', '' . "\0" . 'Bufete\\AplicacionBundle\\Entity\\Cliente' . "\0" . 'celular', '' . "\0" . 'Bufete\\AplicacionBundle\\Entity\\Cliente' . "\0" . 'direccion', 'procesos');
        }
